...
const e = "undefined" != typeof window && null != window.customElements && void 0 !== window.customElements.polyfillWrapFlushCallback,
    ...
    }, i = `{{lit-${String(Math.random()).slice(2)}}}`, n = `\x3c!--${i}--\x3e`, r = new RegExp(`${i}|${n}`);

class o {
    constructor(t, e) {
        this.parts = [], this.element = e;
        const s = [], n = [], o = document.createTreeWalker(e.content, 133, null, !1);
        let l = 0, h = -1, p = 0;
        const {strings: u, values: {length: _}} = t;
        for (; p < _;) {
            const t = o.nextNode();
            if (null !== t) {
                if (h++, 1 === t.nodeType) {
                    if (t.hasAttributes()) {
                        ...
                        for (; i-- > 0;) {
                            const e = u[p], s = d.exec(e)[2], i = s.toLowerCase() + "$lit$", n = t.getAttribute(i);
                            t.removeAttribute(i);
                            const o = n.split(r);
                            this.parts.push({type: "attribute", index: h, name: s, strings: o}), p += o.length - 1
                        }
                    }
                    ...
                    const e = t.data;
                    if (e.indexOf(i) >= 0) {
                        const i = t.parentNode, n = e.split(r), o = n.length - 1;
                        for (let e = 0; e < o; e++) {
                            let s, r = n[e];
                            if ("" === r) s = c(); else {
                                const t = d.exec(r);
                                null !== t && a(t[2], "$lit$") && (r = r.slice(0, t.index) + t[1] + t[2].slice(0, -"$lit$".length) + t[3]), s = document.createTextNode(r)
                            }
                            i.insertBefore(s, t), this.parts.push({type: "node", index: ++h})
                        }
                        "" === n[o] ? (i.insertBefore(c(), t), s.push(t)) : t.data = n[o], p += o
                    }
                } else if (8 === t.nodeType) if (t.data === i) {
                    const e = t.parentNode;
                    null !== t.previousSibling && h !== l || (h++, e.insertBefore(c(), t)), l = h, this.parts.push({
                        type: "node", index: h
                    }), null === t.nextSibling ? t.data = "" : (s.push(t), h--), p++
                } else {
                    let e = -1;
                    for (; -1 !== (e = t.data.indexOf(i, e + 1));) this.parts.push({type: "node", index: -1}), p++
                }
...
const a = (t, e) => {
    ...
    }, l = t => -1 !== t.index, c = () => document.createComment(""),
    d = /([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;

function h(t, e) {
    const {element: {content: s}, parts: i} = t, n = document.createTreeWalker(s, 133, null, !1);
    let r = u(i), o = i[r], a = -1, l = 0;
    const c = [];
    let d = null;
    for (; n.nextNode();) {
        a++;
        const t = n.currentNode;
        for (t.previousSibling === d && (d = null), e.has(t) && (c.push(t), null === d && (d = t)), null !== d && l++; void 0 !== o && o.index === a;) o.index = null !== d ? -1 : o.index - l, r = u(i, r), o = i[r]
    }
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const _ = new WeakMap, m = t => "function" == typeof t && _.has(t), f = {}, y = {};
...
class g {
    ...
    _clone() {
        const t = e ? this.template.element.content.cloneNode(!0) : document.importNode(this.template.element.content, !0),
            s = [], i = this.template.parts, n = document.createTreeWalker(t, 133, null, !1);
        let r, o = 0, a = 0, c = n.nextNode();
        for (; o < i.length;) if (r = i[o], l(r)) {
            for (; a < r.index;) a++, "TEMPLATE" === c.nodeName && (s.push(c), n.currentNode = c.content), null === (c = n.nextNode()) && (n.currentNode = s.pop(), c = n.nextNode());
            if ("node" === r.type) {
...
class x {
    ...
    _getValue() {
        ...
        for (let i = 0; i < e; i++) {
            ...
            if (void 0 !== e) {
                const t = e.value;
                if (w(t) || !b(t)) s += "string" == typeof t ? t : String(t); else for (const e of t) s += "string" == typeof e ? e : String(e)
            }
        }
        return s += t[e], s
    }
...
class N {
    ...
    commit() {
        ...
        const t = this.__pendingValue;
        t !== f && (w(t) ? t !== this.value && this.__commitText(t) : t instanceof S ? this.__commitTemplateResult(t) : t instanceof Node ? this.__commitNode(t) : b(t) ? this.__commitIterable(t) : t === y ? (this.value = y, this.clear()) : this.__commitText(t))
    }
    ...
    __commitText(t) {
        const e = this.startNode.nextSibling, s = "string" == typeof (t = null == t ? "" : t) ? t : String(t);
    ...
    __commitTemplateResult(t) {
        ...
        if (this.value instanceof g && this.value.template === e) this.value.update(t.values); else {
            const s = new g(e, t.processor, this.options), i = s._clone();
    ...
    __commitIterable(t) {
        ...
        const e = this.value;
        let s, i = 0;
        for (const n of t) s = e[i], void 0 === s && (s = new N(this.options), e.push(s), 0 === i ? s.appendIntoPart(this) : s.insertAfterPart(e[i - 1])), s.setValue(n), s.commit(), i++;
...
class V {
    ...
    commit() {
        ...
        const t = this.__pendingValue, e = this.value,
            ...
            i = null != t && (null == e || s);
        s && this.element.removeEventListener(this.eventName, this.__boundHandleEvent, this.__options), i && (this.__options = k(t), this.element.addEventListener(this.eventName, this.__boundHandleEvent, this.__options)), this.value = t, this.__pendingValue = f
    }
...
const k = t => t && (A ? {capture: t.capture, passive: t.passive, once: t.once} : t.capture)
    /**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
...
function O(t) {
    let e = U.get(t.type);
    void 0 === e && (e = {stringsArray: new WeakMap, keyString: new Map}, U.set(t.type, e));
    let s = e.stringsArray.get(t.strings);
    if (void 0 !== s) return s;
    const n = t.strings.join(i);
    return s = e.keyString.get(n), void 0 === s && (s = new o(t, t.getTemplateElement()), e.keyString.set(n, s)), e.stringsArray.set(t.strings, s), s
}

const U = new Map, R = new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
class {
    handleAttributeExpressions(t, e, s, i) {
        const n = e[0];
        if ("." === n) {
            return new E(t, e.slice(1), s).parts
        }
        if ("@" === n) return [new V(t, e.slice(1), i.eventContext)];
...
const q = t => e => {
    const s = j(e.type, t);
    let n = U.get(s);
    void 0 === n && (n = {stringsArray: new WeakMap, keyString: new Map}, U.set(s, n));
    ...
    if (r = n.keyString.get(a), void 0 === r) {
        ...
        $ && window.ShadyCSS.prepareTemplateDom(s, t), r = new o(e, s), n.keyString.set(a, r)
    }
    return n.stringsArray.set(e.strings, r), r
}, I = ["html", "svg"], F = new Set, L = (t, e, s) => {
    F.add(t);
    const i = s ? s.element : document.createElement("template"), n = e.querySelectorAll("style"), {length: r} = n;
    ...
    s ? function (t, e, s = null) {
        ...
        for (; r.nextNode();) {
            l++;
            for (r.currentNode === s && (a = p(e), s.parentNode.insertBefore(e, s)); -1 !== o && n[o].index === l;) {
                if (a > 0) {
...
const B = {
    ...
    W = {attribute: !0, type: String, converter: B, reflect: !1, hasChanged: H};
...
class D extends HTMLElement {
    ...
    static createProperty(t, e = W) {
        ...
        const s = "symbol" == typeof t ? Symbol() : "__" + t, i = this.getPropertyDescriptor(t, s, e);
    ...
    static _propertyValueFromAttribute(t, e) {
        const s = e.type, i = e.converter || B, n = "function" == typeof i ? i : i.fromAttribute;
        return n ? n(t, s) : t
    }
    ...
    _requestUpdate(t, e) {
        let s = !0;
        if (void 0 !== t) {
            const i = this.constructor, n = i.getPropertyOptions(t);
 ...
 */
const X = "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, G = Symbol();
...
class Z extends D {
    ...
    update(t) {
        const e = this.render();
        super.update(t), e !== Y && this.constructor.render(e, this.renderRoot, {
...
Z.finalized = !0, Z.render = (t, e, i) => {
    if (!i || "object" != typeof i || !i.scopeName) throw new Error("The `scopeName` option is required.");
    const n = i.scopeName, r = R.has(e), o = $ && 11 === e.nodeType && !!e.host, a = o && !F.has(n),
        l = a ? document.createDocumentFragment() : e;
    if (((t, e, i) => {
        let n = R.get(e);
        void 0 === n && (s(e, e.firstChild), R.set(e, n = new N(Object.assign({templateFactory: O}, i))), n.appendInto(e)), n.setValue(t), n.commit()
    })(t, l, Object.assign({templateFactory: q(n)}, i)), a) {
        const t = R.get(l);
        R.delete(l);
        const i = t.value instanceof g ? t.value.template : void 0;
        L(n, l, i), s(e, e.firstChild), e.appendChild(l), R.set(e, t)
    }
    !r && o && window.ShadyCSS.styleElement(e.host)
};
console.info("%c  TEXT-DIVIDER-ROW  \n%c  Version 1.4.0     ", "color: orange; font-weight: bold; background: black", "color: white; font-weight: bold; background: dimgray");
let tt = class extends Z {
    setConfig(t) {
        if (!t || !t.text) throw new Error("Error in card configuration.");
        this._config = t
    }

    render() {
        return this._config ? z`
      <h2 class="text-divider test"><span>${this._config.text}</span></h2>
    ` : z``
    }
...
var et, st;
t([(t, e) => void 0 !== e ? ((t, e, s) => {
    e.constructor.createProperty(s, t)
})(et, t, e) : J(et, t)], tt.prototype, "_config", void 0), tt = t([(st = "text-divider-row", t => "function" == typeof t ? ((t, e) => (window.customElements.define(t, e), e))(st, t) : ((t, e) => {
    const {kind: s, elements: i} = e;
    return {
        kind: s, elements: i, finisher(e) {
